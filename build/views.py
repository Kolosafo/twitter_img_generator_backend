...
def design_profile(request):
    ...
    if(party == "APC"):
        ...
        wm_apc_post_design, og_post = post_design(profile_img, party)
        ...
        wm_pdp_post_design, og_post = post_design(profile_img, party)
        ...
        wm_lp_post_design, og_post = post_design(profile_img, party)
        ...
        wm_nnpp_post_design, og_post = post_design(profile_img, party)
